...
public class ClubSportEntity {
    ...
    private Collection<SectionEntity> sectionsByIdClubSport;
    ...
    @OneToMany(mappedBy = "clubSportBySectionFk")
    public Collection<SectionEntity> getSectionsByIdClubSport() {
        return sectionsByIdClubSport;
    }

    public void setSectionsByIdClubSport(Collection<SectionEntity> sectionsByIdClubSport) {
        this.sectionsByIdClubSport = sectionsByIdClubSport;
    }
}
