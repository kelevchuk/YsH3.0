...
public class ClubNumberEntity {
    ...
    private NumberEntity numberByIdNumber;
    ...
    public NumberEntity getNumberByIdNumber() {
        return numberByIdNumber;
    }

    public void setNumberByIdNumber(NumberEntity numberByIdNumber) {
        this.numberByIdNumber = numberByIdNumber;
    }
}
