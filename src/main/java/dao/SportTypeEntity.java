...
public class SportTypeEntity {
    ...
    private Collection<TrainerSportEntity> trainerSportsByIdSport;
    ...
    @OneToMany(mappedBy = "sportTypeByIdSportFk")
    public Collection<TrainerSportEntity> getTrainerSportsByIdSport() {
        return trainerSportsByIdSport;
    }

    public void setTrainerSportsByIdSport(Collection<TrainerSportEntity> trainerSportsByIdSport) {
        this.trainerSportsByIdSport = trainerSportsByIdSport;
    }
}
