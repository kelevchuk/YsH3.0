...
public class AgeEntity {
    ...
    private Collection<SectionEntity> sectionsByIdAge;
    ...
    @OneToMany(mappedBy = "ageByIdAgeFk")
    public Collection<SectionEntity> getSectionsByIdAge() {
        return sectionsByIdAge;
    }

    public void setSectionsByIdAge(Collection<SectionEntity> sectionsByIdAge) {
        this.sectionsByIdAge = sectionsByIdAge;
    }
}
